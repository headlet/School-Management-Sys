...
<section class="bg-[#113975] flex justify-center items-center py-12 gap-x-16 text-white ">
  ...
  <div class="w-[500px] m-7">
    <div id="tabButtons" class="flex space-x-4 mt-14">
      <button class="tab-btn border-b-2 border-transparent hover:border-gray-300 px-2 py-1">Email</button>
    ...
    <div class="p-6">Email dfdshfsdfkjshj</div>
    <img src="{{asset('image/contact.png')}}" alt="contact" class="">
  </div>
</section>
